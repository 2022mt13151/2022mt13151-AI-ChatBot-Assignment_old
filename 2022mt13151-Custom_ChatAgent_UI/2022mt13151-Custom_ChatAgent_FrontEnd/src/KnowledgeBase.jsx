...
const KnowledgeBase = ( ) => {
  ...
  const addEmbedding = (text, embedding) => {
    var base = new Airtable({apiKey: 'patwRYqA3mu2vAGqY.02ad0418322b88e4be6527ca367e28c66a6ba7f122955db8547a7502e8f2f884'}).base('appoftLjpim1zi7Ez');
    base('2022mt13151-AI-Embeddings').create([
      {
        "fields": {
          "Text": text,
          "Embedding": embedding
